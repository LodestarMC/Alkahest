...
import team.lodestar.alkahest.common.block.cauldron.CauldronRenderer;
...
public class BlockEntityRegistration {
    ...
    public static final RegistryObject<BlockEntityType<CauldronBlockEntity>> CAULDRON = BLOCK_ENTITY_TYPES.register("cauldron", () -> BlockEntityType.Builder.of(CauldronBlockEntity::new, BlockRegistration.CAULDRON.get()).build(null));
